                      ...
                      child: TweenAnimationBuilder(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: quickLinks[index]['color'].withOpacity(
                                  0.3,
                                ),
                                spreadRadius: 1,
                                blurRadius: 6,
                        ...
                        child: TweenAnimationBuilder(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  adminLinks[index]['color'].withOpacity(0.9),
                                  adminLinks[index]['color'].withOpacity(0.7),
                                ],
                                begin: Alignment.topLeft,
                                end: Alignment.bottomRight,
                              ),
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: adminLinks[index]['color'].withOpacity(
                                    0.3,
                                  ),
                                  spreadRadius: 1,
                                  blurRadius: 6,
                        ...
                        child: TweenAnimationBuilder(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  hodAdminLinks[index]['color'].withOpacity(
                                    0.9,
                                  ),
                                  hodAdminLinks[index]['color'].withOpacity(
                                    0.7,
